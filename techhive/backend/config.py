...
class Config:
    ...
    BOOTSTRAP_ADMIN_EMAIL = env_value("BOOTSTRAP_ADMIN_EMAIL")
    BOOTSTRAP_ADMIN_PASSWORD = env_value("BOOTSTRAP_ADMIN_PASSWORD")
    BOOTSTRAP_ADMIN_FIRST_NAME = env_value("BOOTSTRAP_ADMIN_FIRST_NAME", "Global")
    BOOTSTRAP_ADMIN_LAST_NAME = env_value("BOOTSTRAP_ADMIN_LAST_NAME", "Admin")
    BOOTSTRAP_ADMIN_PHONE_NUMBER = env_value("BOOTSTRAP_ADMIN_PHONE_NUMBER")
    BOOTSTRAP_ADMIN_EMAIL_VERIFIED = env_bool("BOOTSTRAP_ADMIN_EMAIL_VERIFIED", "true")
    BOOTSTRAP_ADMIN_RESET_PASSWORD_ON_STARTUP = env_bool(
